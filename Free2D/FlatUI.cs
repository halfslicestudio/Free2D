...
{
    [DefaultEvent("TextChanged")]
    public class FlatRichTextBox : Control
    {
        private int W;
        private int H;
        private MouseState State = MouseState.None;
...
namespace FlatUI
{
    public class FormSkin : ContainerControl
    {
        ...
        private Color _BaseColor = Color.FromArgb(60, 70, 73);
        private Color _BorderColor = Color.FromArgb(53, 5, 60);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            _with2.FillEllipse(new SolidBrush(FlatColor), 5, 16, 18, 18);
            _with2.FillEllipse(new SolidBrush(Color.FromArgb(243, 243, 243)), 5, 16, 8, 8);
